...
민화·도예 작가의 작품 세계, 수상 경력, 전시 이력을 체계적으로 소개하여 작가의 전문성과 신뢰도를 강화하는 포트폴리오 웹사이트입니다. Google Stitch로 디자인한 UI를 바탕으로 마크다운 기반의 콘텐츠 관리가 가능한 구조로 개발합니다.
